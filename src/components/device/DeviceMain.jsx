  ...
  return (
    <>
      <main
        className={ `${ bg
          ? ""
          : "bg-linear" } pt-5 flex flex-col md:flex-row justify-center  items-center md:items-end md:gap-20 general-padding md:text-start  pb-10 ${ reverse
          ? "md:flex-row-reverse"
          : "" }` }>
        {
          moreLink &&
