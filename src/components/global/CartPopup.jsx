...
export const CartPopup = ({ open, setOpen }) => {
  ...
  return (
    <Transition in={open} timeout={300} mountOnEnter unmountOnExit>
      {(state) => (
        <>
          <div className="fixed w-screen max-h-500 top-0 left-0 flex flex-col items-center px-4 pt-2 z-50">
            <div
          ...
          ${
            ...
            >
              <div
                className="absolute top-0 right-0 cursor-pointer bg-red-500 text-white w-8 h-8 flex justify-center items-center m-3"
